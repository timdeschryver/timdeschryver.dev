...
fs.writeFileSync('static/dark.theme.css', createStyle('@media (prefers-color-scheme: dark)', pallete))
fs.writeFileSync('static/light.theme.css', createStyle('@media (prefers-color-scheme: light)', palleteDawn))
